...
ikmenesa_iemaksa_entry = Entry(logs, font=("Arial", 16))
ikmenesa_iemaksa_entry.pack(pady=20)

ikmenesas_label = Label(logs, text="Ikmenesā iemaksa", font=("Arial", 16))
...
ikmenesa_iemaksa = Label(logs, text="Manas Iemaksas", font=("Arial", 16))
